...
const statusCode: StatusCodeConfig = {
  ...
  OD_PHONE_EXISTED: {
    code: 1073,
    type: 'OD_PHONE_EXISTED',
    msg: 'Số điện thoại cửa hàng đã tồn tại!',
  },
  ...
  // PRODUCT STATUS
  PRODUCT_NAME_EXISTED: {
    code: 1130,
    type: 'PRODUCT_NAME_EXISTED',
  ...
  // KPI STATUS
  KPI_VOLUME_NOT_FOUND: {
    code: 1160,
    type: 'KPI_VOLUME_NOT_FOUND',
    msg: 'Không tìm thấy KPI Volume!',
  },
  ...
  ROUTE_PLAN_NOT_FOUND: {
    code: 1200,
    type: 'ROUTE_PLAN_NOT_FOUND',
    msg: 'Không tìm thấy đăng ký ghé thăm!',
  },

  // ROUTE_PLAN STATUS
  PRICE_ANALYSIS_NOT_FOUND: {
    code: 1210,
    type: 'PRICE_ANALYSIS_NOT_FOUND',
    msg: 'Không tìm thấy Price analysis!',
  },
  PRICE_BREAKDOWN_NOT_FOUND: {
    code: 1211,
    type: 'PRICE_BREAKDOWN_NOT_FOUND',
    msg: 'Không tìm thấy Price breakdown!',
  },
